				...
				>
					<div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
						<p className="text-blue-200 text-sm leading-relaxed">
							...
							<strong>aircraft callsign</strong> only, not your spoken
							callsign.
						</p>
					</div>
						...
						<div className="space-y-3">
							...
							<div className="bg-zinc-900/50 border border-zinc-700 rounded-lg p-3 mt-3">
								...
								<div className="space-y-1 text-zinc-400 text-xs">
									<p>
										<strong className="text-zinc-300">FAA (US):</strong> Group digits - "United Twenty-Three Fifty-Three" (UAL2353)
									</p>
									<p>
										<strong className="text-zinc-300">ICAO (International):</strong> Individual digits - "United Two Three Five Three" (UAL2353)
									</p>
					...
					<section>
						...
						<div className="space-y-3">
							<p className="text-zinc-300 text-sm leading-relaxed">
								Use your <strong>full tail number/registration</strong>{' '}
