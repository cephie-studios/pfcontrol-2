...
export default function RouteMap({
  ...
  return (
    <div
      ref={containerRef}
      className={className}
      style={{ position: 'relative', width: '100%', height: '100%', background: '#101012' }}
    >
      <DeckGL
        ...
        controller={{
          ...
          inertia: true,
          maxBounds: [[MAP_BOUNDS.minX, MAP_BOUNDS.minY], [MAP_BOUNDS.maxX, MAP_BOUNDS.maxY]],
        }}
        layers={[islandLayer, routeLine, airportLayer, navSymbolLayer, labelLayer]}
      />
    </div>
  )
}
