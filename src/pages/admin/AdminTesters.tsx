                ...
                <div className="flex items-center">
                  <div
                    className={`p-3 rounded-xl mr-4 ${
                      gateEnabled ? 'bg-green-500/20' : 'bg-red-500/20'
                    }`}
                  >
                    {gateEnabled ? (
            ...
            <div className="grid grid-cols-1 gap-6 flex-1 min-w-0">
              <div className="bg-zinc-900 border-2 border-zinc-700/50 rounded-2xl p-6 flex flex-col justify-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-zinc-400 text-lg">Total Testers</p>
                </div>
              </div>
            </div>
          </div>
                      ...
                      {testers.length === 0 ? (
                        <tr>
                          ...
                          >
                            ...
                            <p className="text-sm">
                              Add some testers to get started
                            </p>
                          </td>
                        </tr>
                      ) : (
                        testers.map((tester) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              <Button
                                onClick={() =>
                                  handleRemoveTester(tester.user_id)
                                }
