...
export function validateAccessId(accessId) {
...
export function validateSquawk(squawk) {
...
export function validateFlightLevel(fl) {
...
export function validateStand(stand) {
